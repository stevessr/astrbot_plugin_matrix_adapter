...
async def handle_audio(receiver, chain, event, _: str):
    ...
    rendered = False
    if file_info and receiver.client and receiver._should_auto_download_media("m.audio"):
        try:
    ...
    if not rendered and mxc_url and receiver.client and receiver._should_auto_download_media("m.audio"):
        try:
