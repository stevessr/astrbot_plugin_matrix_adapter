...
async def _probe_video_metadata(video_path: str, info: dict[str, Any]) -> None:
    """Probe video duration and dimensions with ffprobe."""
    try:
...
async def send_video(
    ...
    await _probe_video_metadata(video_path, info)

    content = _build_video_content(
        filename, content_uri, content_type, video_size, info
    )
